...
class CocoDataset(utils.Dataset):
    def load_coco(self, dataset_dir, subset, year=DEFAULT_DATASET_YEAR, class_names=None,
        ...
        if return_coco:
            return coco
    def load_coco2(self, json_path, image_path, class_names=None,return_coco=False):
        """Load a subset of the COCO dataset.
        dataset_dir: The root directory of the COCO dataset.
        subset: What to load (train, val, minival, valminusminival)
        year: What dataset year to load (2014, 2017) as a string, not an integer
        ...
        print ("> {} images of classes {} from coco subset loaded".format(self.dataset_size, class_names))
        if return_coco:
            return coco
